...
--
-- Host: localhost:3306
-- Generation Time: Jan 21, 2025 at 11:47 PM
...
CREATE TABLE `transactions` (
  ...
  `payment_link` text COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `users` (
  ...
  `nomor_hp` text COLLATE utf8mb4_general_ci,
  `alamat_web` text COLLATE utf8mb4_general_ci,
  `tempat_lahir` text COLLATE utf8mb4_general_ci,
  `tanggal_lahir` text COLLATE utf8mb4_general_ci,
  `no_kk` text COLLATE utf8mb4_general_ci,
  `no_ktp` text COLLATE utf8mb4_general_ci,
  `photo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
